      ...
      <div className="row">
        ...
        <div className="col-xl-6 col-lg-6">
          <div className="apihu-port-about-right">
            ...
            <p className="apihu-port-about-text">I am <b> software engineer</b> specializing in <b>diverse software and mobile app development. Leveraging my extensive experience</b>  I design and build tailored, efficient solutions that drive business efficiency and enhance user experience. My skills cover the entire software development lifecycle, delivering high-quality, scalable solutions to complex challenges effectively..</p>
            <div className="apihu-port-about-expertise">
              <ul className="nav nav-pills" id="pills-tab" role="tablist">
                <li className="nav-item">
                  <a className="nav-link active show" id="pills-home-tab" href="https://www.linkedin.com/in/abdalelah-taleb-751044193/" role="tab" aria-controls="pills-home" aria-selected="true"><i className="fa-brands fa-linkedin"></i> LinkedIn</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link active show" id="pills-profile-tab" href="https://github.com/abdalelah1" role="tab" aria-controls="pills-profile" aria-selected="false"><i className="fa-brands fa-square-github"></i> Github</a>
                </li>
              </ul>
              ...
              <div className="tab-content" id="pills-tabContent">
                <div className="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <ul>
                    <li>
                      <span className="apihu-port-expertise-title">Worked with Django, .Net , Nodejs</span>
                    ...
                    <li>
                      <span className="apihu-port-expertise-title">working with <font style={{ color: 'blue' }}>Flutter (A framework by Google)</font>.</span>
                      <span className="apihu-port-expertise-text">Mobile development </span>
                    </li>
                  </ul>
                </div>
              </div>
