         ...
         <a href="https://www.linkedin.com/in/aaditya-raj-053974188/">Aaditya Raj</a>.
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <ul className="social-icons">
              <li><a className="github" href="https://github.com/aaditya1612"><i className="fa fa-github"></i></a></li>
              <li><a className="instagram" href="https://instagram.com/aaditya_c16"><i className="fa fa-instagram"></i></a></li>
              <li><a className="linkedin" href="https://www.linkedin.com/in/aaditya-raj-053974188/"><i className="fa fa-linkedin"></i></a></li>   
            </ul>
          </div>
        </div>
      </div>
